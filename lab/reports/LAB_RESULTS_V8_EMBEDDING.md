...
Total cases: 17
Summary: Hit@1=16/16, Hit@3=16/16, MRR=1.000, AbstainOK=17/17, elapsed=54469ms
...
## Commands executed
- [ok, 63ms] target-context: srcwalk context framework/modelcatalog/pricing.go:28 --scope . --budget 3500
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 100ms, matches=10] symbol-exact: srcwalk discover CalculateCost --as symbol --scope . --limit 10 --budget 3000
- [code=2, 88ms] symbol-lower: srcwalk discover calculatecost --as symbol --scope . --limit 10 --budget 2500
- [ok, 382ms] symbol-glob: srcwalk discover '*calculatecost*' --as symbol --scope . --limit 10 --budget 2500
...
### Expansion 2: context:tests/governance/test_utils.go:64-73 (ok, 57ms)
```text
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 593ms] bm25-prf: bm25 search 'how does model pricing cost calculation work?' --scope framework
- [ok, 53ms] symbol-glob: srcwalk discover '*calculation*' --as symbol --scope framework --limit 12 --budget 2500

## Notes
- BM25 index for scope `framework` has 889 chunks; cold build 591ms, query 593ms.
- Embedding skipped: BM25 cluster: 2/3 top candidates in framework/modelcatalog/pricing_test.go with keyword path hit; RRF keeps strong BM25 evidence authoritative.
...
- [ok, 58ms] symbol-glob: srcwalk discover '*calculatecost*' --as symbol --scope framework --limit 10 --budget 2500
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 49ms] file-deps: srcwalk deps framework/modelcatalog/pricing.go --budget 3500

## Best candidates
1. `framework/modelcatalog/pricing.go:1` — score=90.0, source=file-deps, kind=file

## Evidence expansion
### Expansion 1: deps:framework/modelcatalog/pricing.go (ok, 46ms)
```text
...
- abstained: False
- reason: strong candidate cluster/coverage/score
- top_score: 187.8; top_gap: 2.1; top_file_cluster: 1; path_keyword_coverage: 0.00
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 715ms] bm25-prf: bm25 search 'tests for semantic cache' --scope tests
- [ok, 660ms] embedding-rerank: potion-code-16M rerank 'tests for semantic cache' --pool 8
- [ok, 58ms] fusion-symbol-semantic: srcwalk discover '*semantic*' --as symbol --scope tests --limit 8 --budget 2200
- [ok, 9ms] fusion-file-semantic: srcwalk discover '*semantic*' --as file --scope tests --limit 8 --budget 1800
- [ok, 73ms, matches=4] fusion-symbol-cache: srcwalk discover '*cache*' --as symbol --scope tests --limit 8 --budget 2200
- [ok, 9ms] fusion-file-cache: srcwalk discover '*cache*' --as file --scope tests --limit 8 --budget 1800

## Notes
- BM25 index for scope `tests` has 1194 chunks; cold build 712ms, query 715ms.
- potion-code-16M produced optional embedding rank for RRF; load=650ms warm=False encode=8ms rss_after=233.4MB.
- v8 RRF fused ranks: bm25-prf(36), srcwalk(4), embedding(8)

## Best candidates
1. `tests/integrations/python/tests/test_anthropic.py:1541-1620` — score=187.8, source=rrf-fusion, kind=chunk
2. `tests/integrations/python/tests/test_bedrock.py:1681-1760` — score=185.8, source=rrf-fusion, kind=chunk
3. `tests/integrations/python/tests/test_bedrock.py:1611-1690` — score=182.4, source=rrf-fusion, kind=chunk

## Evidence expansion
### Expansion 1: context:tests/integrations/python/tests/test_anthropic.py:1541-1620 (ok, 77ms)
```text
...
- top_score: 141.9; top_gap: 2.6; top_file_cluster: 3; path_keyword_coverage: 0.00
...
## Commands executed
- [ok, 11300ms] bm25-prf: bm25 search 'where is unicorn payment teleport implemented?' --scope .
- [ok, 22ms] embedding-rerank: potion-code-16M rerank 'where is unicorn payment teleport implemented?' --pool 8
- [code=2, 125ms] symbol-exact: srcwalk discover teleport --as symbol --scope . --limit 10 --budget 3000
- [ok, 462ms] fusion-symbol-teleport: srcwalk discover '*teleport*' --as symbol --scope . --limit 8 --budget 2200
- [ok, 16ms] fusion-file-teleport: srcwalk discover '*teleport*' --as file --scope . --limit 8 --budget 1800
- [ok, 398ms] fusion-symbol-unicorn: srcwalk discover '*unicorn*' --as symbol --scope . --limit 8 --budget 2200
- [ok, 17ms] fusion-file-unicorn: srcwalk discover '*unicorn*' --as file --scope . --limit 8 --budget 1800
- [ok, 388ms] fusion-symbol-payment: srcwalk discover '*payment*' --as symbol --scope . --limit 8 --budget 2200
- [ok, 28ms] fusion-file-payment: srcwalk discover '*payment*' --as file --scope . --limit 8 --budget 1800

## Notes
- BM25 index for scope `.` has 10871 chunks; cold build 11289ms, query 11300ms.
- potion-code-16M produced optional embedding rank for RRF; load=0ms warm=True encode=8ms rss_after=761.4MB.
- symbol-exact failed with code 2
- v8 RRF fused ranks: bm25-prf(36), embedding(8)
...
- [ok, 72ms] file-discover: srcwalk discover src/Uno.Foundation/Rect.cs --as file --scope . --limit 8 --budget 2500
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 2589ms, matches=10] symbol-exact: srcwalk discover Rect --as symbol --scope . --limit 10 --budget 3000
- [ok, 1882ms, matches=10] symbol-lower: srcwalk discover rect --as symbol --scope . --limit 10 --budget 2500
- [ok, 2200ms, matches=10] symbol-glob: srcwalk discover '*rect*' --as symbol --scope . --limit 10 --budget 2500
- [ok, 689ms, matches=10] symbol-text: srcwalk discover Rect --as text --scope . --limit 10 --budget 2500
...
### Expansion 2: context:src/Uno.UI/UI/Xaml/Media/RectangleGeometry.wasm.cs:28-28 (ok, 188ms)
```text
...
### Expansion 3: context:src/Uno.UI/UI/Xaml/Media/RectangleGeometry.wasm.cs:52-52 (ok, 186ms)
```text
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 19161ms] bm25-prf: bm25 search 'how does remote control server start?' --scope src
- [ok, 2071ms, matches=2] symbol-glob: srcwalk discover '*control*' --as symbol --scope src --limit 12 --budget 2500

## Notes
- BM25 index for scope `src` has 32805 chunks; cold build 19134ms, query 19161ms.
- Embedding skipped: BM25 cluster: 3/3 top candidates in src/Uno.UI.RemoteControl.DevServer.Tests/AppLaunch/AppLaunchIntegrationTests.cs with keyword path hit; RRF keeps strong BM25 evidence authoritative.
...
### Expansion 2: context:src/Uno.UI.RemoteControl.DevServer.Tests/AppLaunch/AppLaunchIntegrationTests.cs:141-220 (ok, 41ms)
```text
...
- [code=2, 613ms] symbol-lower: srcwalk discover startcommandasync --as symbol --scope src --limit 10 --budget 2500
- [ok, 2071ms] symbol-glob: srcwalk discover '*startcommandasync*' --as symbol --scope src --limit 10 --budget 2500
- [ok, 741ms, matches=5094] text-any: srcwalk discover StartCommandAsync,calls,call --match any --as text --scope src --limit 10 --budget 3000
...
## Evidence expansion
### Expansion 1: context:src/Uno.UI.RemoteControl.Host/Program.Command.cs:20-222 (ok, 190ms)
```text
...
### Expansion 2: trace-callers:StartCommandAsync (ok, 313ms)
```text
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 47ms] bm25-prf: bm25 search 'tests for InitializeComponent analyzer' --scope src
- [ok, 1011ms, matches=7601] test-text: srcwalk discover InitializeComponent,analyzer,tests,test --match any --as text --scope src --limit 12 --budget 3000
- [ok, 1939ms, matches=12] test-symbol: srcwalk discover '*InitializeComponent*' --as symbol --scope src --limit 12 --budget 2500

## Notes
- BM25 index for scope `src` has 32805 chunks; cold build 19134ms, query 47ms.
- Embedding skipped: BM25 cluster: 3/3 top candidates in src/Uno.Analyzers.Tests/UnoInitializeComponentAnalyzerTests.cs with keyword path hit; RRF keeps strong BM25 evidence authoritative.
...
- [ok, 7ms] embedding-rerank: potion-code-16M rerank 'how does discover rank results?' --pool 8
- [ok, 57ms, matches=6] symbol-glob: srcwalk discover '*discover*' --as symbol --scope src --limit 12 --budget 2500
- [ok, 46ms, matches=6] fusion-symbol-discover: srcwalk discover '*discover*' --as symbol --scope src --limit 8 --budget 2200
- [ok, 15ms] fusion-file-discover: srcwalk discover '*discover*' --as file --scope src --limit 8 --budget 1800
- [ok, 47ms, matches=8] fusion-symbol-rank: srcwalk discover '*rank*' --as symbol --scope src --limit 8 --budget 2200
- [ok, 15ms] fusion-file-rank: srcwalk discover '*rank*' --as file --scope src --limit 8 --budget 1800

## Notes
- BM25 index for scope `src` has 613 chunks; cold build 575ms, query 576ms.
- potion-code-16M produced optional embedding rank for RRF; load=0ms warm=True encode=6ms rss_after=1681.4MB.
- v8 RRF fused ranks: bm25-prf(36), srcwalk(15), embedding(8)
...
3. `src/cli_run.rs:631-710` `run` — score=147.8, source=rrf-fusion, kind=chunk
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 22ms] symbol-exact: srcwalk discover rank_matches --as symbol --scope src --limit 10 --budget 3000
...
- [ok, 31ms, matches=96] text-any: srcwalk discover rank_matches,rank_matche,rank_match,calls --match any --as text --scope src --limit 10 --budget 3000
