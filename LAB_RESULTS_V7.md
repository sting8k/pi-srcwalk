# Query Router Lab Test v7 - Quality Benchmark

Total cases: 17
Summary: Hit@1=16/16, Hit@3=16/16, MRR=1.000, AbstainOK=17/17, elapsed=56758ms


---

## Case 1: bifrost — PASS
# semantic-search lab v7: framework/modelcatalog/pricing.go:28
...
## Commands executed
- [ok, 66ms] target-context: srcwalk context framework/modelcatalog/pricing.go:28 --scope . --budget 3500
...
## Evidence expansion
### Expansion 1: context:framework/modelcatalog/pricing.go:28 (ok, 60ms)
```text
...
### Expansion 3: context:framework/modelcatalog/pricing.go:83-135 (ok, 44ms)
```text
...
## Case 2: bifrost — PASS
# semantic-search lab v7: framework/modelcatalog/pricing.go
repo: /Users/bean/Documents/Develope/Bifrost/bifrost
scope: .
...
## Case 3: bifrost — PASS
# semantic-search lab v7: CalculateCost
repo: /Users/bean/Documents/Develope/Bifrost/bifrost
scope: .
...
- [ok, 484ms] symbol-glob: srcwalk discover '*calculatecost*' --as symbol --scope . --limit 10 --budget 2500
- [ok, 37ms, matches=10] symbol-text: srcwalk discover CalculateCost --as text --scope . --limit 10 --budget 2500
...
## Evidence expansion
### Expansion 1: context:framework/modelcatalog/pricing.go:28-45 (ok, 88ms)
```text
...
### Expansion 2: context:tests/governance/test_utils.go:64-73 (ok, 71ms)
```text
...
### Expansion 3: context:framework/streaming/audio.go:117-199 (ok, 53ms)
```text
...
## Case 4: bifrost — PASS
# semantic-search lab v7: how does model pricing cost calculation work?
repo: /Users/bean/Documents/Develope/Bifrost/bifrost
scope: framework
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 636ms] bm25-prf: bm25 search 'how does model pricing cost calculation work?' --scope framework
- [ok, 51ms] symbol-glob: srcwalk discover '*calculation*' --as symbol --scope framework --limit 12 --budget 2500

## Notes
- BM25 index for scope `framework` has 889 chunks; cold build 634ms, query 636ms.
- Fusion skipped: BM25 cluster: 2/3 top candidates in framework/modelcatalog/pricing_test.go with keyword path hit; preserves strong BM25 cluster.
...
## Evidence expansion
### Expansion 1: context:framework/modelcatalog/pricing.go:771-850 (ok, 25ms)
```text
...
### Expansion 2: context:framework/modelcatalog/pricing.go:1-80 (ok, 25ms)
```text
...
### Expansion 3: context:framework/modelcatalog/pricing.go:71-150 (ok, 26ms)
```text
...
## Case 5: bifrost — PASS
# semantic-search lab v7: who calls CalculateCost?
repo: /Users/bean/Documents/Develope/Bifrost/bifrost
scope: framework
...
- [ok, 23ms, matches=233] text-any: srcwalk discover CalculateCost,calls,call --match any --as text --scope framework --limit 10 --budget 3000
...
## Case 6: bifrost — PASS
# semantic-search lab v7: what does CalculateCost call?
repo: /Users/bean/Documents/Develope/Bifrost/bifrost
scope: framework
...
- [code=2, 22ms] symbol-lower: srcwalk discover calculatecost --as symbol --scope framework --limit 10 --budget 2500
- [ok, 54ms] symbol-glob: srcwalk discover '*calculatecost*' --as symbol --scope framework --limit 10 --budget 2500
- [ok, 16ms, matches=212] text-any: srcwalk discover CalculateCost,call --match any --as text --scope framework --limit 10 --budget 3000
...
### Expansion 2: trace-callees:CalculateCost (ok, 42ms)
```text
...
## Case 7: bifrost — PASS
# semantic-search lab v7: deps of framework/modelcatalog/pricing.go
repo: /Users/bean/Documents/Develope/Bifrost/bifrost
scope: .
...
## Evidence expansion
### Expansion 1: deps:framework/modelcatalog/pricing.go (ok, 34ms)
```text
...
# semantic-search lab v7: tests for semantic cache
repo: /Users/bean/Documents/Develope/Bifrost/bifrost
scope: tests
...
- abstained: False
- reason: strong candidate cluster/coverage/score
- top_score: 143.0; top_gap: 2.0; top_file_cluster: 1; path_keyword_coverage: 0.00
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 735ms] bm25-prf: bm25 search 'tests for semantic cache' --scope tests
...
- [ok, 76ms, matches=4] fusion-symbol-cache: srcwalk discover '*cache*' --as symbol --scope tests --limit 8 --budget 2200
- [ok, 8ms] fusion-file-cache: srcwalk discover '*cache*' --as file --scope tests --limit 8 --budget 1800

## Notes
- BM25 index for scope `tests` has 1194 chunks; cold build 733ms, query 735ms.

## Best candidates
1. `tests/integrations/python/tests/test_anthropic.py:1541-1620` — score=143.0, source=bm25-prf, kind=chunk
2. `tests/integrations/python/tests/test_bedrock.py:1681-1760` — score=141.0, source=bm25-prf, kind=chunk
3. `tests/integrations/python/tests/test_bedrock.py:1611-1690` — score=138.9, source=bm25-prf, kind=chunk
...
### Expansion 3: context:tests/integrations/python/tests/test_bedrock.py:1611-1690 (ok, 48ms)
```text
...
# semantic-search lab v7: where is unicorn payment teleport implemented?
repo: /Users/bean/Documents/Develope/Bifrost/bifrost
scope: .
...
## Commands executed
- [ok, 11619ms] bm25-prf: bm25 search 'where is unicorn payment teleport implemented?' --scope .
- [code=2, 97ms] symbol-exact: srcwalk discover teleport --as symbol --scope . --limit 10 --budget 3000
- [ok, 401ms] fusion-symbol-teleport: srcwalk discover '*teleport*' --as symbol --scope . --limit 8 --budget 2200
- [ok, 16ms] fusion-file-teleport: srcwalk discover '*teleport*' --as file --scope . --limit 8 --budget 1800
- [ok, 467ms] fusion-symbol-unicorn: srcwalk discover '*unicorn*' --as symbol --scope . --limit 8 --budget 2200
- [ok, 18ms] fusion-file-unicorn: srcwalk discover '*unicorn*' --as file --scope . --limit 8 --budget 1800
- [ok, 423ms] fusion-symbol-payment: srcwalk discover '*payment*' --as symbol --scope . --limit 8 --budget 2200
- [ok, 16ms] fusion-file-payment: srcwalk discover '*payment*' --as file --scope . --limit 8 --budget 1800

## Notes
- BM25 index for scope `.` has 10871 chunks; cold build 11607ms, query 11619ms.
...
## Case 10: uno — PASS
# semantic-search lab v7: src/Uno.Foundation/Rect.cs
...
- [ok, 63ms] file-discover: srcwalk discover src/Uno.Foundation/Rect.cs --as file --scope . --limit 8 --budget 2500

## Best candidates
1. `src/Uno.Foundation/Rect.cs:1` — score=133.0, source=file-discover, kind=file

## Evidence expansion
### Expansion 1: context:src/Uno.Foundation/Rect.cs:1 (ok, 32ms)
```text
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 2711ms, matches=10] symbol-exact: srcwalk discover Rect --as symbol --scope . --limit 10 --budget 3000
- [ok, 2052ms, matches=10] symbol-lower: srcwalk discover rect --as symbol --scope . --limit 10 --budget 2500
- [ok, 2354ms, matches=10] symbol-glob: srcwalk discover '*rect*' --as symbol --scope . --limit 10 --budget 2500
- [ok, 746ms, matches=10] symbol-text: srcwalk discover Rect --as text --scope . --limit 10 --budget 2500
...
### Expansion 2: context:src/Uno.UI/UI/Xaml/Media/RectangleGeometry.wasm.cs:28-28 (ok, 195ms)
```text
...
### Expansion 3: context:src/Uno.UI/UI/Xaml/Media/RectangleGeometry.wasm.cs:52-52 (ok, 188ms)
```text
...
## Case 12: uno — PASS
# semantic-search lab v7: how does remote control server start?
repo: /Users/bean/Documents/Develope/uno
scope: src
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 19841ms] bm25-prf: bm25 search 'how does remote control server start?' --scope src
- [ok, 2552ms, matches=2] symbol-glob: srcwalk discover '*control*' --as symbol --scope src --limit 12 --budget 2500

## Notes
- BM25 index for scope `src` has 32805 chunks; cold build 19811ms, query 19841ms.
- Fusion skipped: BM25 cluster: 3/3 top candidates in src/Uno.UI.RemoteControl.DevServer.Tests/AppLaunch/AppLaunchIntegrationTests.cs with keyword path hit; preserves strong BM25 cluster.
...
## Evidence expansion
### Expansion 1: context:src/Uno.UI.RemoteControl.VS/EntryPoint.TelemetryEventListener.cs:1-65 (ok, 31ms)
```text
...
### Expansion 3: context:src/Uno.UI.RemoteControl.DevServer.Tests/AppLaunch/AppLaunchIntegrationTests.cs:1-80 (ok, 41ms)
```text
...
## Case 13: uno — PASS
# semantic-search lab v7: who calls StartCommandAsync?
repo: /Users/bean/Documents/Develope/uno
scope: src
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 490ms, matches=2] symbol-exact: srcwalk discover StartCommandAsync --as symbol --scope src --limit 10 --budget 3000
- [code=2, 676ms] symbol-lower: srcwalk discover startcommandasync --as symbol --scope src --limit 10 --budget 2500
- [ok, 2386ms] symbol-glob: srcwalk discover '*startcommandasync*' --as symbol --scope src --limit 10 --budget 2500
- [ok, 808ms, matches=5094] text-any: srcwalk discover StartCommandAsync,calls,call --match any --as text --scope src --limit 10 --budget 3000
...
## Evidence expansion
### Expansion 1: context:src/Uno.UI.RemoteControl.Host/Program.Command.cs:20-222 (ok, 219ms)
```text
...
### Expansion 2: trace-callers:StartCommandAsync (ok, 347ms)
```text
...
## Case 14: uno — PASS
# semantic-search lab v7: overview of src/Uno.UI.RemoteControl.Host
repo: /Users/bean/Documents/Develope/uno
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 47ms] overview: srcwalk overview --scope src/Uno.UI.RemoteControl.Host --symbols

## Best candidates
- none parsed

## Evidence expansion
### Expansion 1: overview (ok, 47ms)
```text
...
## Case 15: uno — PASS
# semantic-search lab v7: tests for InitializeComponent analyzer
repo: /Users/bean/Documents/Develope/uno
scope: src
...
- abstained: False
- reason: strong candidate cluster/coverage/score
- top_score: 163.0; top_gap: 2.2; top_file_cluster: 3; path_keyword_coverage: 1.00
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 51ms] bm25-prf: bm25 search 'tests for InitializeComponent analyzer' --scope src
- [ok, 1116ms, matches=7601] test-text: srcwalk discover InitializeComponent,analyzer,tests,test --match any --as text --scope src --limit 12 --budget 3000
- [ok, 2271ms, matches=12] test-symbol: srcwalk discover '*InitializeComponent*' --as symbol --scope src --limit 12 --budget 2500

## Notes
- BM25 index for scope `src` has 32805 chunks; cold build 19811ms, query 51ms.
- Fusion skipped: BM25 cluster: 3/3 top candidates in src/Uno.Analyzers.Tests/UnoInitializeComponentAnalyzerTests.cs with keyword path hit; preserves strong BM25 cluster.
...
## Evidence expansion
### Expansion 1: context:src/Uno.Analyzers.Tests/UnoInitializeComponentAnalyzerTests.cs:211-264 (ok, 38ms)
```text
...
### Expansion 2: context:src/Uno.Analyzers.Tests/UnoInitializeComponentAnalyzerTests.cs:141-220 (ok, 36ms)
```text
...
### Expansion 3: context:src/Uno.Analyzers.Tests/UnoInitializeComponentAnalyzerTests.cs:71-150 (ok, 35ms)
```text
...
# semantic-search lab v7: how does discover rank results?
...
- abstained: False
- reason: strong candidate cluster/coverage/score
- top_score: 153.0; top_gap: 35.0; top_file_cluster: 1; path_keyword_coverage: 0.50
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 355ms] bm25-prf: bm25 search 'how does discover rank results?' --scope src
- [ok, 55ms, matches=6] symbol-glob: srcwalk discover '*discover*' --as symbol --scope src --limit 12 --budget 2500
- [ok, 49ms, matches=6] fusion-symbol-discover: srcwalk discover '*discover*' --as symbol --scope src --limit 8 --budget 2200
- [ok, 14ms] fusion-file-discover: srcwalk discover '*discover*' --as file --scope src --limit 8 --budget 1800
- [ok, 48ms, matches=8] fusion-symbol-rank: srcwalk discover '*rank*' --as symbol --scope src --limit 8 --budget 2200
- [ok, 13ms] fusion-file-rank: srcwalk discover '*rank*' --as file --scope src --limit 8 --budget 1800

## Notes
- BM25 index for scope `src` has 613 chunks; cold build 354ms, query 355ms.

## Best candidates
1. `src/search/rank.rs:1` — score=153.0, source=file-discover, kind=file
2. `src/search/rank/tests.rs:1` — score=118.0, source=file-discover, kind=file
3. `src/cli_run.rs:631-710` `run` — score=103.0, source=bm25-prf, kind=chunk

## Evidence expansion
### Expansion 1: context:src/search/rank.rs:1 (ok, 22ms)
```text
...
### Expansion 2: context:src/search/rank/tests.rs:1 (ok, 21ms)
```text
...
### Expansion 3: context:src/cli_run.rs:631-710 (ok, 50ms)
```text
...
# semantic-search lab v7: who calls rank_matches?
repo: /Users/bean/Documents/Develope/Ultra-lab/tilth
scope: src
...
- hit1: True; hit3: True; mrr: 1.000; abstain_ok: True; matched_rank: 1
## Commands executed
- [ok, 23ms] symbol-exact: srcwalk discover rank_matches --as symbol --scope src --limit 10 --budget 3000
- [ok, 21ms] symbol-lower: srcwalk discover rank_matches --as symbol --scope src --limit 10 --budget 2500
...
### Expansion 2: trace-callers:rank_matches (ok, 14ms)
```text
